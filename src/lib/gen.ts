...
export function initGenParam(param: any, dial: any, running: {
	current: boolean,
	timeoutRef?: any
}, volatility: number, driftSwitchChance: number, timeout: number) {
...
export async function startGen(params: Record<string, ParamDialEntry>, runningFlags: Map<string, {
	current: boolean,
	timeoutRef?: any
}>, forceRestart: boolean = false, options: { volatility: number, driftSwitchChance: number, timeout: number }) {
...
export function updateGen(params: Record<string, ParamDialEntry>, runningFlags: Map<string, {
	current: boolean,
	timeoutRef?: any
}>, options: { volatility: number, driftSwitchChance: number, timeout: number }) {
